...
class ShmemVecEnv(VecEnv):
    ...
    def step_wait(self):
        ...
        self.waiting_step = False
        obs, rews, terminated, truncated, infos = zip(*outs)
        return self._decode_obses(obs), np.array(rews), np.array(terminated), np.array(truncated), infos
        ...
        while True:
            ...
            if cmd == 'reset':
                ...
                try:
                    ...
                    pipe.send((_write_obs(obs), reward, done, False, info))
            elif cmd == 'render':
