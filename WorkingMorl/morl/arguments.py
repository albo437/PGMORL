...
def get_parser():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='skip saving model files (.pt and .pkl) to save disk space')
    ...
    parser.add_argument(
        ...
        type=int,
        default=64,
        help='hidden layer size for MLP networks')
    parser.add_argument(
        '--use-flexible-cnn',
        action='store_true',
        default=False,
        help='use flexible CNN architecture for image observations')
    parser.add_argument(
        '--cnn-preset',
        type=str,
        choices=['atari', 'meltingpot', 'deep_nature', 'lightweight'],
        help='CNN architecture preset to use')
